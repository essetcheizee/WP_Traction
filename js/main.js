...
var st = $(this).scrollTop() / 10;
  ...
  function firstLoadAnim() {
    ...
    TweenMax.fromTo($bgSlider, .75,{width:'100%'}, {width:'0%', ease: Sine.easeInOut}, 1)
  ...
  $('.featured-slider').on('beforeChange', function (event, slick, currentSlide, nextSlide) {
    ...
    TweenLite.set($bgSlider, {scale:1.15})
    TweenLite.set($bgSlider.find('img').attr('src', active), {opacity:1 ,scale:1.15})
    TweenMax.fromTo($bgSlider, 1.2, {width: "100%"}, {width: "0%",  ease: Sine.easeInOut}, 1);  
  })
